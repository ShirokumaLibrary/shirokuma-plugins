...
description: "要件定義フェーズを統括するオーケストレーター。ADR 作成を write-adr に委任し、仕様 Discussion は CLI で直接作成し、create-item-flow への接続を管理する。トリガー: 「要件定義」「要件整理」「ADR作成して」「仕様作成して」「仕様を整理したい」"
