...
| Type（Issue Types） | 種別から決定 | feature → Feature、bug → Bug、chore → Chore、docs → Docs、research → Research（`--issue-type` オプションで指定） |
...
| フィールド | 選択肢 | デフォルト |
|-----------|--------|----------|
| Issue Type | Feature / Bug / Task / Chore / Docs / Research | （種別判定から） |
