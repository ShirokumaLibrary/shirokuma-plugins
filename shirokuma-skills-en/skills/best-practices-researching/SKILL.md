...
**Reference patterns** (provided in `nextjs-vibe-coding` skill knowledge base):
...
```bash
shirokuma-docs discussions create --category Research --title "[Research] {topic}" --body "{findings}"
```
...
- Results can be passed to `nextjs-vibe-coding` skill for implementation
