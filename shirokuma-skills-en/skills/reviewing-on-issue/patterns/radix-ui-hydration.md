# Radix UI Hydration Pattern (Important)
...
Radix UI components generate different dynamic IDs on SSR vs client:
...
- `LanguageSwitcher`
- All Radix UI primitives that generate IDs

## Placeholder Requirements

1. **Match the appearance**: Same look as the trigger button
2. **Disable interaction**: Use the `disabled` prop
3. **Maintain accessibility**: Keep `sr-only` text
