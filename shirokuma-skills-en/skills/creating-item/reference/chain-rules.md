...
| Size M+ or requirements ambiguous | `/review-issue requirements` (review then plan) | Review ensures requirements and spec quality |
...
| Priority: Critical/High | Follow Size-based default above (XS/S → `/implement-flow`, M+ → `/review-issue requirements`) | High urgency, Size determines path |
...
|-----------|-----------------|--------|
| Size M or larger | Yes | Broad impact scope — verify requirements and spec quality first |
